...
return (new CustomEvent(event_name,(function (){var obj26816 = ({"detail":data});
return obj26816;
})()));
} else {
...
var f = (function (){var pred__26823 = cljs.core._EQ_;
var expr__26824 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26823.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26824))){
return ((function (pred__26823,expr__26824){
return (function (p1__26817_SHARP_){
return console.warn(p1__26817_SHARP_);
});
;})(pred__26823,expr__26824))
} else {
if(cljs.core.truth_(pred__26823.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26824))){
return ((function (pred__26823,expr__26824){
return (function (p1__26818_SHARP_){
return console.debug(p1__26818_SHARP_);
});
;})(pred__26823,expr__26824))
} else {
if(cljs.core.truth_(pred__26823.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26824))){
return ((function (pred__26823,expr__26824){
return (function (p1__26819_SHARP_){
return console.error(p1__26819_SHARP_);
});
;})(pred__26823,expr__26824))
} else {
return ((function (pred__26823,expr__26824){
return (function (p1__26820_SHARP_){
return console.log(p1__26820_SHARP_);
});
;})(pred__26823,expr__26824))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26827){
...
var eval_fn = cljs.core.get.call(null,map__26828__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26830_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26832,(0),null);
var v = cljs.core.nth.call(null,vec__26832,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1582209464216

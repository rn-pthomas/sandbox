...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__7440_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_7441 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_7442 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_7441);
var pos_7443 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_7441);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_7442);

var tr__1729__auto___7444 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_7442) - cljs.core.first(pos_7443)),(((quil.core.height() / (2)) / zoom_7442) - cljs.core.second(pos_7443))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__1729__auto___7444);
...
var G__7445 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__7446 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__7445,G__7446) : user_mouse_dragged.call(null,G__7445,G__7446));
...
return (function (state,event){
var G__7447 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__7448 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__7447,G__7448) : user_mouse_wheel.call(null,G__7447,G__7448));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
